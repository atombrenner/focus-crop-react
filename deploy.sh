...
echo "<head><meta http-equiv=\"refresh\" content=\"0;URL='${TARGET/s3/https}/index.html'\"/></head>" >/tmp/redirect
aws s3 cp /tmp/redirect "${TARGET}" --cache-control "public,max-age=31536000" --content-type "text/html" --no-progress